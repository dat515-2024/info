...
4. You will then be invited to the course organization on GitHub and two separate repositories.
   ...
   - Navigate to the course organization [dat515-2024](https://github.com/dat515-2024) accept the invitation.
   - Navigate to the [assignments](https://github.com/dat515-2024/assignments) repository and accept the invitation.
   - Navigate to your private <https://github.com/dat515-2024/username-labs> repository and accept the invitation.
...
5. Once you have accepted the invitations, you will get your own repository under `dat515-2024`, which is the course's organization on GitHub.
...
2. To join the course Discord server, navigate [here](DISCORD_JOIN_URL).
...
3. Once connected to the server, please register with our bot, `@BOT_USER`, by sending it a direct message or by sending the command in the `#general` channel:
   ...
   Hence, please make sure that you have joined the [`dat515-2024`](https://github.com/dat515-2024) GitHub organization and registered with QuickFeed first.
